package GachaLife_fla
{
   ...
   public dynamic class chohosepose_5218 extends MovieClip
   {
      ...
      public function chohosepose_5218()
      {
         super();
      ...
      public function updatepose() : void
      {
         ...
         {
            MovieClip(root)["skitpose1m" + parent.selectleft] = this.addnum + this.posepick;
         }
         else
         {
            MovieClip(root)["skitpose2m" + parent.selectright] = this.addnum + this.posepick;
         }
         this.updateselect();
      }
      ...
      public function updateselect() : void
      {
         ...
         if(this.charselect == 1)
         {
            this.posething = MovieClip(root)["skitpose1m" + parent.selectleft];
         }
         else
         {
            this.posething = MovieClip(root)["skitpose2m" + parent.selectright];
         }
