package GachaLife_fla
{
   ...
   public dynamic class opendisplay_4927 extends MovieClip
   {
      ...
      public function opendisplay_4927()
      {
         super();
      ...
      public function leftbtx(evt:MouseEvent) : void
      {
         ...
         if(MovieClip(root).opencustompage == 1)
         {
            if(MovieClip(root).opencustompageon == 10)
            {
               MovieClip(root).opencustompageon = MovieClip(root).hairdownpage;
            }
            if(MovieClip(root).opencustompageon == 0)
            {
               MovieClip(root).opencustompageon = 10 + MovieClip(root).hairuppage;
            }
         }
         else if(MovieClip(root).opencustompage == 2)
         {
            if(MovieClip(root).opencustompageon == 10)
            {
               MovieClip(root).opencustompageon = MovieClip(root).hairdownpage;
         ...
         else if(MovieClip(root).opencustompageon < 1)
         {
      ...
      public function rightbtx(evt:MouseEvent) : void
      {
         ...
         if(MovieClip(root).opencustompage == 1)
         {
            if(MovieClip(root).opencustompageon == MovieClip(root).hairdownpage + 1)
            {
               MovieClip(root).opencustompageon = 11;
            }
            if(MovieClip(root).opencustompageon > 10 + MovieClip(root).hairuppage)
            {
         ...
         else if(MovieClip(root).opencustompageon > MovieClip(root).openmaxpages)
         {
            MovieClip(root).opencustompageon = 1;
         }
         this.itemon.gotoAndStop(21);
