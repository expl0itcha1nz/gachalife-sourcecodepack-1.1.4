package GachaLife_fla
{
   ...
   public dynamic class typegoz_5209 extends MovieClip
   {
      ...
      public function colorupdate() : void
      {
         ...
         this.emote.gotoAndStop(this.emotex);
         if(this.charselect == 1)
         {
            MovieClip(root)["skitchat1m" + parent.selectleft] = this.typex.typex.text;
            MovieClip(root)["skitbubblecolor1m" + parent.selectleft] = this.bubcolor;
            MovieClip(root)["skittextcolor1m" + parent.selectleft] = this.txtcolor;
            MovieClip(root)["skitemote1m" + parent.selectleft] = this.emotex;
         }
         else
         {
            MovieClip(root)["skitchat2m" + parent.selectright] = this.typex.typex.text;
            MovieClip(root)["skitbubblecolor2m" + parent.selectright] = this.bubcolor;
            MovieClip(root)["skittextcolor2m" + parent.selectright] = this.txtcolor;
            MovieClip(root)["skitemote2m" + parent.selectright] = this.emotex;
         }
         parent.updateskit();
      }
      ...
      public function emotebtx(evt:MouseEvent) : void
      {
         if(MovieClip(root).mutesfx == 1)
         {
            MovieClip(root).myChannel4 = MovieClip(root).clicksfx.play(0,1);
      ...
      public function typebtx(evt:MouseEvent) : void
      {
         ...
         if(this.charselect == 1)
         {
            this.typex.typex.text = MovieClip(root)["skitchat1m" + parent.selectleft];
         }
         else
         {
            this.typex.typex.text = MovieClip(root)["skitchat2m" + parent.selectright];
         }
      }
      ...
      public function savebtx(evt:MouseEvent) : void
      {
         ...
         if(this.charselect == 1)
         {
            ...
            MovieClip(root)["skitchat1m" + parent.selectleft] = this.s;
            MovieClip(root)["skitbubblecolor1m" + parent.selectleft] = this.bubcolor;
            MovieClip(root)["skittextcolor1m" + parent.selectleft] = this.txtcolor;
         }
         else
         {
            ...
            MovieClip(root)["skitchat2m" + parent.selectright] = this.s;
            MovieClip(root)["skitbubblecolor2m" + parent.selectright] = this.bubcolor;
            MovieClip(root)["skittextcolor2m" + parent.selectright] = this.txtcolor;
         }
         parent.updateskit();
      ...
      public function bubblebtx(evt:MouseEvent) : void
      {
         ...
         if(this.charselect == 1)
         {
            MovieClip(root)["skittalk1m" + parent.selectleft] = this.bubble;
         }
         else
         {
            MovieClip(root)["skittalk2m" + parent.selectright] = this.bubble;
         }
         this.colorupdate();
      }
      ...
      function frame2() : *
      {
         ...
         {
            this.typex.typex.text = MovieClip(root)["skitchat1m" + parent.selectleft];
            this.bubble = MovieClip(root)["skittalk1m" + parent.selectleft];
            this.bubcolor = MovieClip(root)["skitbubblecolor1m" + parent.selectleft];
            this.txtcolor = MovieClip(root)["skittextcolor1m" + parent.selectleft];
            this.emotex = MovieClip(root)["skitemote1m" + parent.selectleft];
         }
         else
         {
            this.typex.typex.text = MovieClip(root)["skitchat2m" + parent.selectright];
            this.bubble = MovieClip(root)["skittalk2m" + parent.selectright];
            this.bubcolor = MovieClip(root)["skitbubblecolor2m" + parent.selectright];
            this.txtcolor = MovieClip(root)["skittextcolor2m" + parent.selectright];
            this.emotex = MovieClip(root)["skitemote2m" + parent.selectright];
         }
         ...
         this.emotebt.addEventListener(MouseEvent.MOUSE_DOWN,this.emotebtx);
