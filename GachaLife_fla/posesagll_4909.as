package GachaLife_fla
{
   ...
   public dynamic class posesagll_4909 extends MovieClip
   {
      ...
      public function posesagll_4909()
      {
         super();
      ...
      public function closebtx(evt:MouseEvent) : void
      {
         ...
         parent.posex.char.gotoAndStop(MovieClip(root)["stance" + MovieClip(root).slot]);
         parent.stancetxt.text = "Pose." + MovieClip(root)["stance" + MovieClip(root).slot];
         gotoAndStop(1);
         MovieClip(root).rightbar.visible = true;
         MovieClip(root).openthing = 1;
      }
      
      public function shadowbtx(evt:MouseEvent) : void
      {
         if(MovieClip(root)["shadow" + MovieClip(root).slot] == 1)
         {
            MovieClip(root)["shadow" + MovieClip(root).slot] = 2;
         }
         else
         {
            MovieClip(root)["shadow" + MovieClip(root).slot] = 1;
         }
         MovieClip(root).updatechar();
         this.shadowx.gotoAndStop(MovieClip(root)["shadow" + MovieClip(root).slot]);
      }
      ...
      public function updatepose() : void
      {
         ...
         MovieClip(root)["stance" + MovieClip(root).slot] = this.addnum + this.posepick;
         MovieClip(root).updatechar();
         this.updateselect();
      }
      ...
      public function updateselect() : void
      {
         ...
         this.posething = MovieClip(root)["stance" + MovieClip(root).slot];
